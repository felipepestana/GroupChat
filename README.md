...
Essa é a classe do Cliente responsável que implementa a interfaceClient definida anteriormente, e, que portanto, oferece uma implementação para o assinatura de método definido dentro da mesma.
